...
function onClick(){
  ...
  let promise = getPromise(url);  // it will be executed two functions: resolve and reject we will store the promise function in local object.
  ...
  promise.then(function(data){
    ...
    // we will check if the user not found in the url dont dispaly in the page give mesg not found
    ...
    {
    // In this section call promise that will deal with user's repos 
...
//This section function will display the correct repo each time the user click button in (html under User Repos) will show up task
// I tried to do scrollable list to display user repo it will not dispaly repo i just create button to show the repo it will dispaly few repo task 
...
// This function will be used when you press search button will disaply the user deatils 
